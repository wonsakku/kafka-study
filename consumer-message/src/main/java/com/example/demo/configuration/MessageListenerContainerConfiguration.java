...
import com.example.demo.consumer.listener.DefaultMessageListener;
...
public class MessageListenerContainerConfiguration {
    ...
    public KafkaMessageListenerContainer<String, String> kafkaMessageListenerContainer(){
        ...
        final KafkaMessageListenerContainer<String, String> container = new KafkaMessageListenerContainer<>(containerFactory(), containerProps);
